		...
		case MenuPage_Opening:
		{
			...
			else
			{
				...
				//Fallthrough
					...
					case 11:
						menu.font_bold.draw(&menu.font_bold, "SUSSY", SCREEN_WIDTH2, SCREEN_HEIGHT2 -8, FontAlign_Center);
						menu.font_bold.draw(&menu.font_bold, "BUSSY", SCREEN_WIDTH2, SCREEN_HEIGHT2 +8,  FontAlign_Center);
				//Fallthrough
					case 10:
					case 9:
						menu.font_bold.draw(&menu.font_bold, "I LOVE", SCREEN_WIDTH2, SCREEN_HEIGHT2 -24, FontAlign_Center);
						break;
	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{"2", StageId_2_1, "SPOOKY MONTH", {"SPOOKEEZ", "SOUTH", NULL, NULL}},
				{"3", StageId_3_1, "PICO", {"PICO", "PHILLY NICE", "BLAMMED", NULL}},
				{"4", StageId_4_1, "MOMMY MUST MURDER", {"SATIN PANTIES", "HIGH", "MILF", NULL}},
				{"5", StageId_5_1, "RED SNOW", {"COCOA", "EGGNOG", "WINTER HORRORLAND", NULL}},
				{"6", StageId_6_1, "HATING SIMULATOR", {"SENPAI", "ROSES", "THORNS", NULL}},
				{"7", StageId_8_1, "SMOKE EM OUT STRUGGLE", {"HEADACHE", "NERVES", "RELEASE", "FADING",}},
			};
			   ...
			   if (pad_state.press & (PAD_START | PAD_CROSS))
				...
				//Fallthrough
					case 1:
						...
						menu.font_bold.draw(&menu.font_bold, "BY", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 16, FontAlign_Center);
						break;
				...
				//Fallthrough
					case 3:
						menu.font_bold.draw(&menu.font_bold, "PORTED", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 32, FontAlign_Center);
						menu.font_bold.draw(&menu.font_bold, "BY",           SCREEN_WIDTH2, SCREEN_HEIGHT2 - 16, FontAlign_Center);
						break;

				   case 6:
						menu.font_bold.draw(&menu.font_bold, "dark_moon", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 16, FontAlign_Center);
					 
					case 5:
						menu.font_bold.draw(&menu.font_bold, "ARTIST OF THE PORT", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 32, FontAlign_Center);
						break;
                    
					 case 8:
					    menu.font_bold.draw(&menu.font_bold, "lord scout", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 16, FontAlign_Center);

					case 7:
						menu.font_bold.draw(&menu.font_bold, "PLAYTESTER", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 32, FontAlign_Center);
						break;
					 
					 case 10:
					    menu.font_bold.draw(&menu.font_bold, "atsuover", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 16, FontAlign_Center);
						menu.font_bold.draw(&menu.font_bold, "rageminer", SCREEN_WIDTH2, SCREEN_HEIGHT2, FontAlign_Center);

					case 9:
						menu.font_bold.draw(&menu.font_bold, "GARCELLO MOD CREATORS", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 32, FontAlign_Center);
						break;
					
					 case 12:
						menu.font_bold.draw(&menu.font_bold, "zeriben", SCREEN_WIDTH2, SCREEN_HEIGHT2 -16, FontAlign_Center);
						menu.font_bold.draw(&menu.font_bold, "g3yt", SCREEN_WIDTH2, SCREEN_HEIGHT2, FontAlign_Center);
						menu.font_bold.draw(&menu.font_bold, "psxfunkin discord server", SCREEN_WIDTH2, SCREEN_HEIGHT2 +16, FontAlign_Center);
					...
					case 11:
						...
						case 14:
						menu.font_bold.draw(&menu.font_bold, "NOW GET OUT", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 16, FontAlign_Center);
