...
void Back_Week8a1_DrawBG(StageBack *back)
{
	Back_Week8a1 *this = (Back_Week8a1*)back;
	...
	static const struct Back_Week8a1_BodyPiece
	{
		RECT src;
		fixed_t scale;
	} body_piece[] = {
	...
	const struct Back_Week8a1_BodyPiece *body_p = body_piece;
	...
	static const struct Back_Week8a1_FloorPiece
	{
		RECT src;
		fixed_t scale;
	} floor_piece[] = {
	...
	const struct Back_Week8a1_FloorPiece *floor_p = floor_piece;
	...
	static const struct Back_Week8a1_FencePiece
	{
		RECT src;
		fixed_t scale;
	} fence_piece[] = {
	...
	const struct Back_Week8a1_FencePiece *fence_p = fence_piece;
	...
	static const struct Back_Week8a1_WallPiece
	{
		RECT src;
		fixed_t scale;
	} wall_piece[] = {
	...
	const struct Back_Week8a1_WallPiece *wall_p = wall_piece;
...
void Back_Week8a1_Free(StageBack *back)
{
	Back_Week8a1 *this = (Back_Week8a1*)back;
...
StageBack *Back_Week8a1_New()
{
	//Allocate background structure
	Back_Week8a1 *this = (Back_Week8a1*)Mem_Alloc(sizeof(Back_Week8a1));
	if (this == NULL)
		return NULL;
	...
	this->back.draw_bg = Back_Week8a1_DrawBG;
	this->back.free = Back_Week8a1_Free;
	
	//Load background textures
	IO_Data arc_back = IO_Read("\\WEEK8A1\\BACK.ARC;1");
