...
static const XA_TrackDef xa_tracks[] = {
	...
	{XA_Week6B, XA_LENGTH(10298)}, //XA_Thorns
	 //WEEKGA.XA
	{XA_WeekGA, XA_LENGTH(11000)}, //XA_Headache
	{XA_WeekGA, XA_LENGTH(11500)}, //XA_Nerves
	//WEEKGB.XA
	{XA_WeekGB, XA_LENGTH(14320)}, //XA_Release
	{XA_WeekGB, XA_LENGTH(4100)}, //XA_Fading
};
...
static const char *xa_paths[] = {
	...
	"\\MUSIC\\WEEKGA.XA;1", //XA_WeekGA
	"\\MUSIC\\WEEKGB.XA;1", //XA_WeekGB
	NULL,
};
...
static const XA_Mp3 xa_mp3s[] = {
	...
	//WEEKGA.XA
	{"headache", true}, //XA_Headache
	{"nerves", true},  //XA_Nerves
	//WEEKGB.XA
	{"release", true}, //XA_Release
	{"fading", true}, //XA_Fading
